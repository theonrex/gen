  ...
  return (
    <div>
      <div className="firstimage">
        <div>
          <div className="innergride0">
            <li className="innergride0">
              <div className="slider1">
                <Image src="/Brenda.PNG" alt="logo" width="200px" height="200px" className="sliderimg" />
                <Image src="/Amy.PNG" alt="logo" width="200px" height="200px"  className="sliderimg"/>
