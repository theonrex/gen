...
function Navbar () {
  ...
  return (
    ...
    <div className='fixed z-[100] flex md:justify-evenly items-center justify-between w-full h-20 px-2 2xl:px-16 bg-black'>
        ...
        <div>
          <ul className='hidden md:flex text-gray-400 font-Righteous '>
            ...
            <li className='ml-10 text-2xl uppercase hover:text-white'>
              <Link className="cursor-pointer" acticeClass ="active" to='team' spy={true} smooth={true} offset={50} duration={500}>Team</Link>
            </li>
