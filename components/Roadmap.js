...
function Roadmap () {
    return (
    < div id="roadmap"className=' grid md:grid-flow-col justify-between md:px-24 sm:px-10 p-4 border-b-2 border-white md:pb-8'>
        
<div className= "mt-4 pt-2 w-full md:mr-8"> 
 <span className=" font-Righteous tracking-wide uppercase text-white text-3xl">Roadmap</span>
 <br/>
   <div className="items-start justify-start flex flex-col mt-4 ">
     ...
     <div className="flex flex-col items-start justify-start mt-4 ">
       <div className=" font-Righteous text-2xl text-orange-600"> 100%
         <p className="text-medium text-gray-400 ml-4 font-sans text-[20px]">Launch Baby Y00ts YC for holders of PYYC <br/> 
         <span className="text-medium text-red-600 font-sans text-[20px]"> Part 2 - Top Secret</span></p>
       </div>
