...
contract GREATDANEAI is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://greatdaneai.mypinata.cloud/ipfs/QmdWqPjg1k9howsnu7NGV5GFgRvGoQvRDALmfv1zgip5KA/unrevealed.json";
    ...
    uint256 public constant MAX_NFT_SUPPLY = 3812;

    constructor() ERC721("GREAT DANE AI", "GDA") {
    }
